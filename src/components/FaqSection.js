...
const ImagePreloader = ({ sources }) => {
  return (
    <div style={{ display: 'none' }}>
      {sources.map(src => (
        <img key={src} src={src} alt="Preloaded character animation" />
      ))}
    </div>
  );
};
...
export default function FaqSection() {
  ...
  return (
    <section id="faqs">
      ...
      >
        <ImagePreloader sources={gifSources} />
